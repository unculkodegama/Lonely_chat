<?php
// source: C:\xampp\htdocs\OnlyChat_project\app\presenters/templates/Rooms/default.latte

use Latte\Runtime as LR;

class Template1d803cf17d extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
            <p> Nothing to see here! Move along citizen. </p>
...
<section id="template">
        <h2>This page template located at <span><?php echo LR\Filters::escapeHtmlText(strstr($this->getName(), 'app')) /* line 40 */ ?></span></h2>

        <pre><code class="jush"><?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->replacere, file_get_contents($this->getName()), '#[\w+/]{60,}#', '…')) /* line 42 */ ?></code></pre>
	</section>

	<section id="layout">
		<h2>Layout template located at <span><?php echo LR\Filters::escapeHtmlText(strstr($this->getParentName(), 'app')) /* line 46 */ ?></span></h2>

		<pre><code class="jush"><?php echo LR\Filters::escapeHtmlText(file_get_contents($this->getParentName())) /* line 48 */ ?></code></pre>
	</section>

	<section id="presenter">
		<h2>Current presenter located at <span><?php echo LR\Filters::escapeHtmlText(strstr($presenter->getReflection()->getFileName(), 'app')) /* line 52 */ ?></span></h2>

		<pre><code class="jush-php"><?php echo LR\Filters::escapeHtmlText(file_get_contents($presenter->getReflection()->getFileName())) /* line 54 */ ?></code></pre>
	</section>
</div>
<?php
	}
