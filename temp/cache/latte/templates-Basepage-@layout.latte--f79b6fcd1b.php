                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="" class="pokus" data-toggle="modal" data-target="#newRoom" ><span class="glyphicon glyphicon-comment"></span>  Nová miestnosť </a></li>
            ...
            <div class="modal-dialog">
                <div class="loginmodal-container">
                    <div class="modal-body">
                        <div>Miestnosť bola aktualizovaná.</div>
                    </div>
                </div>
            </div>
        </div>
