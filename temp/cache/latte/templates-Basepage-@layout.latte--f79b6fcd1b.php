...
<body id="body_image" style='background-image: url("<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::escapeCss($basePath)) /* line 17 */ ?>/images/obr1.JPG")'>
<?php
		$iterations = 0;
            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 43 */ ?>/sign/out"><span class="glyphicon glyphicon-log-in"></span>  Odhlásiť sa</a></li>
                    </ul>
                </div>
            </div>
        </div>
